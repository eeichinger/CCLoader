...
5. Upgrade to firmware V609 with the Manufactor upgrade tool [HMSoft-10-2541-V609.zip](\Bin\HMSoft-10-2541-V609.zip). [Info](https://forum.arduino.cc/index.php?topic=393655.0)<br>  
