...
VCC (Pin 12) to 3.3V <br>
  ...
  ![image](CCLoader.jpg)
3. Use CCLoader.exe to load the CC2541hm10v609.bin (or HMSoft-10-2541-V707.bin) to burn the firmware via the NodeMCU to the HM-10 <br>
   `CCLoader_x86_64.exe [Number of the COM port] CC2541hm10v609.bin 0` <br>
